      ...
      <div className="container main-container ">
        ...
        {/* <div className={styles.mainContainer} > */}
            ...
            <div className={styles["col-2"]} >
              <div className={styles["ms-TextField"]}>
                <div className="form-check">
                  <span>
                    <label className={`${styles["ms-Label"]}  ${styles.labelposition} `} htmlFor="gridCheck">
                      Deceased
                </label>
          ...
          <div className={styles.row}>
            ...
            <div className={styles["col-4"]}>
                <div className={`${styles["ms-CheckBoxField"]} ${styles["align-checkbox"]} `}>
        ...
        <div className={styles.row}>
          <div className={styles["col-2"]}>
          <div className={`${styles["ms-TextField"]}`}>
              <label className={styles["ms-Label"]} htmlFor="formGroupExampleInput">GST#</label>
        ...
        <hr className="marigin"/>
          ...
          <div className={styles["col-11"]}>
           ...
           <input type="text" className="form-control form-control-te "  ref={node=>this.refe2 = node}  value={this.state.selectedComment["_gcomment"]} id="formGroupExampleInput" placeholder=" " onChange={(e)=>this.changeComment(e)} />
            ...
            <div className={`${styles["col-11"]} ${styles["icons-align"]}`}>
          ...
          <div className={`${styles.row} ${styles["tableborder"]}`}>
          <div className={styles["col-12"]}></div>
         ...
         <div className={styles.row}>
          <div className={`${styles["col-12"]} ${styles["scroll-table"]}`}>
          <table className="table table-bordered table-striped">
